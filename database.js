...
class Database {
    ...
    connect() {
        mongoose.connect("mongodb+srv://hyperlynkdb:bFkm9Z15CSZ0fxhQ@hyperlynkdatabasecluste.2jhj0.mongodb.net/hyperlynkdatabasecluster?retryWrites=true&w=majority")
        .then(() => {
